  ...
  it("should render an empty document", () => {
    const document = m.doc(
      ...
      m.list
        ...
        .style("X"),
      m.listItem.task(true, "This is a checked task"),
      m.list
        .ordered("Item 1", "Item 2", m.url("Item 3", "https://www.google.com"))
        .startingIndex(3),
      m.listItem.ordered(1, "Item 1"),
      m.list.unordered("Item 1", m.b("Item 2"), "Item 3").style("*"),
      m.listItem.unordered("Item 1"),
      ...
      m.sec(
        m.h("heading 2").id("heading-1"),
        m.list.unordered("Item 1", "Item 2", "Item 3").style("*"),
        m.para(
          "This is a section ",
